...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/admin/category/': RouteRecordInfo<'/admin/category/', '/admin/category', Record<never, never>, Record<never, never>>,
    '/admin/goods/': RouteRecordInfo<'/admin/goods/', '/admin/goods', Record<never, never>, Record<never, never>>,
